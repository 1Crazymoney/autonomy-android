...
class AutocompleteRecyclerViewAdapter : RecyclerView.Adapter<AutocompleteRecyclerViewAdapter.VH>() {
    ...
    private val items = mutableListOf<SymptomModelView>()

    private var itemClickListener: ((SymptomModelView) -> Unit)? = null

    private var searchText = ""

    fun setItemClickListener(listener: (SymptomModelView) -> Unit) {
        this.itemClickListener = listener
    }

    fun set(items: List<SymptomModelView>, searchText: String) {
    ...
    class VH(view: View, itemClickListener: ((SymptomModelView) -> Unit)?) :
        RecyclerView.ViewHolder(view) {

        private lateinit var item: SymptomModelView
        ...
        fun bind(item: SymptomModelView, searchText: String) {
            this.item = item
            with(itemView) {
