...
class SymptomAddingFragment : BaseSupportFragment() {
    ...
    companion object {
        ...
        fun newInstance(
            data: NewSymptomData = NewSymptomData(),
            type: Type = Type.TITLE
        ): SymptomAddingFragment {
            val fragment = SymptomAddingFragment()
        ...
        fun extractResultData(data: Intent?) = data?.getParcelableExtra<SymptomModelView>(DATA)
    }

    @Inject
    internal lateinit var viewModel: SymptomAddingViewModel
    ...
    private lateinit var data: NewSymptomData
    ...
    override fun layoutRes(): Int = R.layout.fragment_symptom_adding
    ...
    override fun initComponents() {
        ...
        tvSlogan.setText(
            when (type) {
                Type.TITLE -> R.string.create_title_for_symptom
                Type.DESCRIPTION -> R.string.you_can_add_des_for_symptom
            }
        )
    ...
    override fun observe() {
        ...
        viewModel.addSymptomLiveData.asLiveData().observe(this, Observer { res ->
            when {
                res.isSuccess() -> {
                    progressBar.gone()
                    val dialog = BottomAlertDialog(
                        context!!,
                        R.string.added,
                        R.string.your_symptom_has_been_added,
                        R.string.thanks_for_taking_time_to_make_community_healthier_symptom,
                        R.string.ok
                    )
